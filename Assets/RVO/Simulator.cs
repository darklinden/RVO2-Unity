...
namespace RVO
{
    ...
    public class Simulator
    {
         ...
         * this agent.</param>
         */
        public int addAgent(Vec2 position, float neighborDist, int maxNeighbors, float timeHorizon, float timeHorizonObst, float radius, float maxSpeed, Vec2 velocity)
        {
            Agent agent = new Agent();
            agent.id_ = s_totalID;
            s_totalID++;
         ...
         */
        public Vec2 getAgentPosition(int agentNo)
        {
         ...
         */
        public Vec2 getAgentPrefVelocity(int agentNo)
        {
         ...
         */
        public Vec2 getAgentVelocity(int agentNo)
        {
         ...
         */
        public void setAgentDefaults(float neighborDist, int maxNeighbors, float timeHorizon, float timeHorizonObst, float radius, float maxSpeed, Vec2 velocity)
        {
            if (defaultAgent_ == null)
            {
         ...
         * position.</param>
         */
        public void setAgentPosition(int agentNo, Vec2 position)
        {
         ...
         */
        public void setAgentPrefVelocity(int agentNo, Vec2 prefVelocity)
        {
         ...
         * velocity.</param>
         */
        public void setAgentVelocity(int agentNo, Vec2 velocity)
        {
        ...
        public int GetCollisions(Vec2 point, float radius)
        {
            return kdTree_.queryNearAgent(point, radius);
        }
    }
