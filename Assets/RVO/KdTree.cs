...
namespace RVO
{
    ...
    internal partial class KdTree
    {
         ...
         */
        internal void buildAgentTree(RVOSimulator simulator)
        {
         ...
         */
        internal void buildObstacleTree(RVOSimulator simulator)
        {
         ...
         * tested.</param>
         */
        internal bool queryVisibility(Vec2 q1, Vec2 q2, float radius)
        {
            return queryVisibilityRecursive(q1, q2, radius, obstacleTree_);
        }

        internal int queryNearAgent(Vec2 point, float radius)
        {
         ...
         */
        private ObstacleTreeNode buildObstacleTreeRecursive(RVOSimulator simulator, IList<Obstacle> obstacles)
        {
        ...
        private void queryAgentTreeRecursive(Vec2 position, ref float rangeSq, ref int agentNo, int node)
        {
         ...
         * <param name="node">The current obstacle k-D node.</param>
         */
        private bool queryVisibilityRecursive(Vec2 q1, Vec2 q2, float radius, ObstacleTreeNode node)
        {
            if (node == null)
            {
                return true;
