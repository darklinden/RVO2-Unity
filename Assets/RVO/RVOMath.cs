...
namespace RVO
{
    ...
    public struct RVOMath
    {
         ...
         */
        public static float absSq(Vec2 vector)
        {
         ...
         * matrix.</param>
         */
        internal static float det(Vec2 vector1, Vec2 vector2)
        {
         ...
         * be calculated.</param>
         */
        internal static float distSqPointLineSegment(Vec2 vector1, Vec2 vector2, Vec2 vector3)
        {
         ...
         * calculated.</param>
         */
        internal static float leftOf(Vec2 a, Vec2 b, Vec2 c)
        {
            return det(a - c, b - a);
        }
